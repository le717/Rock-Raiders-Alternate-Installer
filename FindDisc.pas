...
begin
	...
	begin
    // A standard LEGO Rock Raiders disc was detected
...
begin
	...
	begin
		MsgBox('A disc drive was not found on your computer.', mbError, MB_OK);
		Abort;
	end;
	...
	begin
		...
		begin
			if MsgBox('Is there a LEGO Rock Raiders CD in your computer? If not, please insert it and press OK.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
